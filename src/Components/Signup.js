...
function Signup() {
  ...
  const handlePatientSubmit = (event) => {
    ...
    fetch(url, requestOptions)
      ...
      .then((response) => handlePatientSignup(response))
  ...
  const handleDoctorSubmit = (event) => {
    ...
    fetch(url, requestOptions)
      .then((response) => (response = response.json()))
      .then((response) => handleDoctorSignup(response))
      .catch((error) => console.log("Form submit error", error));
  };
  return (
    <>
            ...
            <form method="post">
              ...
              <div className="forminput">
                ...
                <input
                  ...
                  name="phoneno"
                  value={dphoneno}
                  onChange={(event) => setDPhoneno(event.target.value)}
                  required
                />
              </div>
              <br />
              <div className="forminput">
                ...
                <input
                  ...
                  name="phoneno"
                  value={deducation}
                  onChange={(event) => setDEducation(event.target.value)}
                  required
                />
              </div>
              <br />
              <div className="forminput">
                ...
                <input
                  ...
                  name="phoneno"
                  value={dspeciality}
                  onChange={(event) => setDSpeciality(event.target.value)}
                  required
                />
              </div>
              <br />
      ...
      <div className="login">
        <p>
          Having an Account?<a href="/">Login</a>
        </p>
      </div>
    </>
  );
